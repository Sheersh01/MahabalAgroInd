...
const Description = () => {
  return (
    <div className="min-h-screen w-full lg:px-12 md:px-8 px-4 lg:py-20 md:py-10 py-10">
      <h1 className="lg:mb-20 md:mb-12 mb-10 lg:text-[3vw] md:text-[4vw] text-[6vw] text-center">
        We're passionate about modernizing{" "}
        <span className="overflow-hidden lg:w-50 md:w-40 w-20 h-8 translate-y-2 lg:h-16 md:h-10 rounded-full inline-block lg:translate-y-4 md:translate-y-3">
